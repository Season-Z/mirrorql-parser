...
export default class MirrorLexer extends Lexer {
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(this, MirrorLexer._ATN, MirrorLexer.DecisionsToDFA, new PredictionContextCache());
	}

	public get grammarFileName(): string { return "MirrorQL.g4"; }

	public get literalNames(): (string | null)[] { return MirrorLexer.literalNames; }
	public get symbolicNames(): (string | null)[] { return MirrorLexer.symbolicNames; }
	public get ruleNames(): string[] { return MirrorLexer.ruleNames; }

	public get serializedATN(): number[] { return MirrorLexer._serializedATN; }

	public get channelNames(): string[] { return MirrorLexer.channelNames; }

	public get modeNames(): string[] { return MirrorLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!MirrorLexer.__ATN) {
			MirrorLexer.__ATN = new ATNDeserializer().deserialize(MirrorLexer._serializedATN);
		}

		return MirrorLexer.__ATN;
	}


	static DecisionsToDFA = MirrorLexer._ATN.decisionToState.map( (ds: DecisionState, index: number) => new DFA(ds, index) );
}